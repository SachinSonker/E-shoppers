...
import { AppBar, styled, Toolbar, Typography, Box, Button, IconButton , TextField, endAdornment } from '@mui/material';
...
const Navbar = () => {
    return (
                ...
                <AppBar  color='transparent' elevation={0} sx={{position:'fixed',zIndex:1}}>
                    <Toolbar sx={{ display: "flex",borderBottom:'1px solid #000',padding:'0 0 20px',marginLeft:'200px',marginRight:'200px'}}>
