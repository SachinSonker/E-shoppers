    ...
    return (
        <div className="productDetails" >
            ...
            <div className="product-data">
                ...
                <p className="product-data-price ">Price: <s>₹ {(prodObj.price)}</s></p>
                <p className="product-data-price product-data-real-price">Deal of the day : ₹ {(prodObj.price - (prodObj.price*0.14)).toFixed(2)} (14% OFF)</p>
                <p>
                    <span>
                        Description:&nbsp;</span>
